...
import BiobankingArticles from "./BiobankingArticles";
import ViabilityArticles from "./ViabilityArticles";
import SopArticles from "./SopArticles";
...
const MoreMe = () => {
    ...
    return(
        ...
        <div>
            {biobanking && <BiobankingArticles/>}
            {viability && <ViabilityArticles/>}
            {sop && <SopArticles/>}
        </div>
        </>
    )
